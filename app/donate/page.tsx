    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-[960px] mx-auto px-4 py-16 text-center">
        ...
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          ...
          impact in the community. Every donation makes a difference.
        </p>

        <DonationDialog
          openByDefault={isDialogOpen}
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          ...
          <div className="p-6">
            ...
            <p className="text-muted-foreground">
              Your donation is tax-deductible. You&apos;ll receive a receipt for
              your records via email.
            </p>
          </div>
          <div className="p-6">
            <h3 className="text-lg font-semibold mb-3">100% Impact</h3>
            <p className="text-muted-foreground">
              Every dollar you donate goes directly to supporting our programs
              and initiatives.
            </p>
          </div>
        </div>
